...
public class Glowing_object : MonoBehaviour
{
    ...
    private float brightness = 1.0f; // Initial brightness value (1.0 corresponds to 100% brightness)
    ...
    void Update()
    {
        ...
        brightness = Mathf.Clamp(brightness, 0.85f, 1.0f);
        ...
        if (brightness <= 0.85f || brightness >= 1.0f)
        {
